...
// In-page anchors are absolute so they keep working from any route. They point
// at /platform, not /, because "/" is the shop's own website (see (site)/page.tsx).
const navLinks = [
  { label: "Features", href: "/platform#features" },
  { label: "Showcase", href: "/platform#showcase" },
  { label: "Pricing", href: "/platform#pricing" },
  { label: "Shop", href: "/" },
  { label: "Try demo", href: "/platform#demo" },
...
export default async function PlatformPage() {
  ...
  const footerConfig: FooterConfig = {
    ...
    links: [
      {
        group: "Navigate",
        items: [{ label: "Platform", href: "/platform" }, ...navLinks],
      },
      {
        group: "Support",
