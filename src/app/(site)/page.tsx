...
const siteDescription =
  "Watches, earbuds, chargers, powerbanks and mobile accessories in Nepal. Browse the shop, pay with eSewa or cash on delivery, and get it delivered.";
...
export default async function HomePage() {
  ...
  return (
    <SiteShell>
      <Hero
        eyebrow="Watches · Audio · Mobile accessories"
        title="Gear for your phone,"
        titleAccent="and your wrist."
        description={`${shopName} stocks watches, earbuds, chargers, powerbanks and the everyday accessories that keep your phone going. Order in a few taps and pay with eSewa or cash on delivery.`}
