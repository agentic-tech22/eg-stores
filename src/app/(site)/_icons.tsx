/**
 * Lightweight Lucide-style SVG icons used on the landing page.
 * Consistent 24×24 viewBox, 2px stroke, currentColor. No emoji icons.
 */
...
// Filled WhatsApp brand glyph: uses fill (not the stroke-based Svg helper).
