...
const DEFAULT_MESSAGE =
  "Your subscription has ended. Please reach out to your admin, or chat with support to renew and restore access to your dashboard.";

/**
 * Full-screen, non-dismissible lock rendered by the admin layout in place of the
 * dashboard when the subscription has lapsed. A blurred, decorative backdrop
 * stands in for the dashboard. No real data is rendered behind it.
 */
export function SubscriptionLockScreen({
  ...
  const message = status.lockedMessage?.trim() || DEFAULT_MESSAGE;
